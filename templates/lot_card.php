<li class="lots__item lot">
  <div class="lot__image">
    <img
      src="<?= isset($lot['lot_img']) && file_exists($lot['lot_img']) ? strip_tags($lot['lot_img']) : get_default_image_src(); ?>"
      width="350" height="260" alt="<?= strip_tags($lot['title']) ?>">
  </div>
  <div class="lot__info">
    ...
    <div class="lot__state">
      <div class="lot__rate">
        ...
        <?php if (isset($lot['end_date'])) : ?>
          <div
            class="lot__timer timer <?= strtotime($lot['end_date']) === strtotime('tomorrow') ? 'timer--finishing' : '' ?>">
