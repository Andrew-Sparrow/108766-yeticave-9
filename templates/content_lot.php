...
<head>
  <meta charset="UTF-8">
  <title>
    <?php if(isset($lot[0]['start_price'])): ?>
      <?= $lot[0]['title']?>
    <?php endif;?>
  </title>
      ...
      <div class="lot-item__content">
        <div class="lot-item__left">
          <div class="lot-item__image">
            <?php if(isset($lot[0]['img_src'])): ?>
              <img src="../<?= strip_tags($lot[0]['img_src'])?>" width="730" height="548" alt="" >
            <?php endif; ?>
          </div>
          <p class="lot-item__category">Категория:
            <?php if(isset($lot[0]['category'])):?>
              <span><?= $lot[0]['category']?></span>
            <?php endif; ?>
          </p>
          <p class="lot-item__description">
            <?php if(isset($lot[0]['description'])):?>
              <?= $lot[0]['description']?>
            <?php endif; ?>
          </p>
        </div>
        <div class="lot-item__right">
          <div class="lot-item__state">
            <div class="lot-item__timer timer
              <?php echo validate_less_hour(strtotime($lot[0]['end_date'])) ? "timer--finishing" : "" ?> ">
              <?= get_formatted_time(strtotime($lot[0]['end_date']))?>
            </div>
            <div class="lot-item__cost-state">
              ...
              <div class="lot-item__min-cost">
                ...
                <span>
                  <?php if(isset($lot[0]['start_price'])): ?>
                    <?= format_number(intval($lot[0]['start_price']));?>
                  <?php endif; ?> р
                </span>
              </div>
            </div>
